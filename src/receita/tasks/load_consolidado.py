...
class LoadConsolidacao(Pipeline):
    ...
    def run(self) -> dict:
        ...
        self.log['duration_transform'] = (
            finish_polars_transform -
            start_polars_transform).total_seconds()
        self.load()
        return self.log
    ...
    def extract_transform_dataset(self) -> None:
        self.dataset = (
            ...
            .group_by(['data', 'produto_id', 'vendedor_id', 'tipo_id'])
    ...
    def _venda_dataset(self) -> pl.DataFrame:
        ...
        schema = {
            ...
            'vendedor__equipe_venda__loja_id': {'rename': 'loja_id', 'type': pl.Int64},
            'valor_receita_bruta': {'rename': 'valor_receita_bruta', 'type': pl.Float64},
            'vendedor__equipe_venda__percent_comissao': {'rename': 'percent_comissao', 'type': pl.Float64},
        }
        qs = (
